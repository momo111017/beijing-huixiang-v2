export const UI_COPY = {
  ru: {
    ...
    homeLead: "Пять знаковых мест. Маршрут через железную дорогу, первые торговые дома, историческую архитектуру, мемориал памяти и парк у набережной раскроет для вас век русско-китайского взаимодействия в Харбине.",
    ...
    routeKicker: "МАРШРУТ 01 · ХАРБИН", routeTitle: "Пять остановок городского диалога", routeIntro: "Выберите точку на карте или продолжите маршрут с текущей остановки.", progress: "Прогресс маршрута", openGuide: "Открыть гид",
    ...
    source: "Источник", correct: "Верно", wrong: "Попробуйте ещё раз", noAnswer: "В текущей базе нет ответа", routeFinished: "Маршрут завершён. Открыть архив", audioReady: "Готов к воспроизведению", audioError: "Не удалось загрузить аудио — используйте текст.", mapReady: "Загружены пять точек маршрута", mapError: "Карта недоступна. Пять точек маршрута остаются доступны в списке.", selectedStop: "Текущая остановка",
  },
  zh: {
